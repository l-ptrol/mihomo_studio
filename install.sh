...
echo "=== Управляющая команда установлена! ==="
echo "Запуск установки/проверки сервиса..."
echo "--------------------------------------------"

# 4. Запуск установки или рестарт сервиса
# Флаг -restart гарантирует, что сервис будет запущен, даже если файлы уже существуют.
